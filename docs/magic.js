const __MAGIC__=()=>{var i,m,e,a,p,s,t,n,o,l,c,d,r,x,v,u,g,f,h,b;let{h:w,app:k}=(i={},e=(m=[]).map,a=Array.isArray,p="u">typeof requestAnimationFrame?requestAnimationFrame:setTimeout,s=function(i){var m="";if("string"==typeof i)return i;if(a(i)&&i.length>0)for(var e,p=0;p<i.length;p++)""!==(e=s(i[p]))&&(m+=(m&&" ")+e);else for(var p in i)i[p]&&(m+=(m&&" ")+p);return m},t=function(i,m){var e={};for(var a in i)e[a]=i[a];for(var a in m)e[a]=m[a];return e},n=function(i){return i.reduce(function(i,m){return i.concat(m&&!0!==m?"function"==typeof m[0]?[m]:n(m):0)},m)},o=function(i,m){if(i!==m)for(var e in t(i,m)){var p,s;if(i[e]!==m[e]&&(p=i[e],s=m[e],!(a(p)&&a(s))||p[0]!==s[0]||"function"!=typeof p[0]))return!0;m[e]=i[e]}},l=function(i,m,e){for(var a,p,s=0,t=[];s<i.length||s<m.length;s++)a=i[s],t.push((p=m[s])?!a||p[0]!==a[0]||o(p[1],a[1])?[p[0],p[1],p[0](e,p[1]),a&&a[2]()]:a:a&&a[2]());return t},c=function(i,m,e,a,p,n){if("key"===m);else if("style"===m)for(var o in t(e,a))e=null==a||null==a[o]?"":a[o],"-"===o[0]?i[m].setProperty(o,e):i[m][o]=e;else"o"===m[0]&&"n"===m[1]?((i.actions||(i.actions={}))[m=m.slice(2)]=a)?e||i.addEventListener(m,p):i.removeEventListener(m,p):!n&&"list"!==m&&"children"!==m&&m in i?i[m]=null==a?"":a:null!=a&&!1!==a&&("class"!==m||(a=s(a)))?"children"!==m&&i.setAttribute(m,a):i.removeAttribute(m)},d=function(i,m,e){var a=i.props,p=3===i.type?document.createTextNode(i.name):(e=e||"svg"===i.name)?document.createElementNS("http://www.w3.org/2000/svg",i.name,{is:a.is}):document.createElement(i.name,{is:a.is});for(var s in a)c(p,s,null,a[s],m,e);for(var t=0,n=i.children.length;t<n;t++)p.appendChild(d(i.children[t]=g(i.children[t]),m,e));return i.node=p},r=function(i){return null==i?null:i.key},x=function(i,m,e,a,p,s){if(e===a);else if(null!=e&&3===e.type&&3===a.type)e.name!==a.name&&(m.nodeValue=a.name);else if(null==e||e.name!==a.name)m=i.insertBefore(d(a=g(a),p,s),m),null!=e&&i.removeChild(e.node);else{var n,o,l,v,u=e.props,f=a.props,h=e.children,b=a.children,w=0,k=0,y=h.length-1,j=b.length-1;for(var z in s=s||"svg"===a.name,t(u,f))("value"===z||"selected"===z||"checked"===z?m[z]:u[z])!==f[z]&&c(m,z,u[z],f[z],p,s);for(;k<=j&&w<=y&&null!=(l=r(h[w]))&&l===r(b[k]);)x(m,h[w].node,h[w],b[k]=g(b[k++],h[w++]),p,s);for(;k<=j&&w<=y&&null!=(l=r(h[y]))&&l===r(b[j]);)x(m,h[y].node,h[y],b[j]=g(b[j--],h[y--]),p,s);if(w>y)for(;k<=j;)m.insertBefore(d(b[k]=g(b[k++]),p,s),(o=h[w])&&o.node);else if(k>j)for(;w<=y;)m.removeChild(h[w++].node);else{for(var z=w,q={},C={};z<=y;z++)null!=(l=h[z].key)&&(q[l]=h[z]);for(;k<=j;){if(l=r(o=h[w]),v=r(b[k]=g(b[k],o)),C[l]||null!=v&&v===r(h[w+1])){null==l&&m.removeChild(o.node),w++;continue}null==v||1===e.type?(null==l&&(x(m,o&&o.node,o,b[k],p,s),k++),w++):(l===v?(x(m,o.node,o,b[k],p,s),C[v]=!0,w++):null!=(n=q[v])?(x(m,m.insertBefore(n.node,o&&o.node),n,b[k],p,s),C[v]=!0):x(m,o&&o.node,null,b[k],p,s),k++)}for(;w<=y;)null==r(o=h[w++])&&m.removeChild(o.node);for(var z in q)null==C[z]&&m.removeChild(q[z].node)}}return a.node=m},v=function(i,m){for(var e in i)if(i[e]!==m[e])return!0;for(var e in m)if(i[e]!==m[e])return!0},u=function(i){return"object"==typeof i?i:h(i)},g=function(i,m){return 2===i.type?((!m||!m.lazy||v(m.lazy,i.lazy))&&((m=u(i.lazy.view(i.lazy))).lazy=i.lazy),m):i},f=function(i,m,e,a,p,s){return{name:i,props:m,children:e,node:a,type:s,key:p}},h=function(e,a){return f(e,i,m,a,void 0,3)},b=function(m){return 3===m.nodeType?h(m.nodeValue,m):f(m.nodeName.toLowerCase(),i,e.call(m.childNodes,b),m,void 0,1)},{h:function(m,e){for(var p,s=[],t=[],n=arguments.length;n-- >2;)s.push(arguments[n]);for(;s.length>0;)if(a(p=s.pop()))for(var n=p.length;n-- >0;)s.push(p[n]);else!1===p||!0===p||null==p||t.push(u(p));return e=e||i,"function"==typeof m?m(e,t):f(m,e,t,void 0,e.key)},app:function(i){var m={},e=!1,s=i.view,t=i.node,o=t&&b(t),c=i.subscriptions,d=[],r=function(i){f(this.actions[i.type],i)},v=function(i){return m!==i&&(m=i,c&&(d=l(d,n([c(m)]),f)),s&&!e&&p(h,e=!0)),m};let{middleware:g=i=>i}=i,f=g((i,e)=>"function"==typeof i?f(i(m,e)):a(i)?"function"==typeof i[0]||a(i[0])?f(i[0],"function"==typeof i[1]?i[1](e):i[1]):(n(i.slice(1)).map(function(i){i&&i[0](f,i[1])},v(i[0])),m):v(i));var h=function(){e=!1,t=x(t.parentNode,t,o,o=u(s(m)),r)};f(i.init)}}),y=i=>(m={},e)=>{let a=(i,...m)=>m.some(m=>m===typeof i);if(a(e,"undefined")){if(m.props)return w(i,{},[m]);a(m,"string","number","function")||Array.isArray(m)?(e=m,m={}):a(m.View,"function")&&(e=m.View,m={})}return w(i,m,e)},j=y("a"),z=y("button"),q=y("circle"),C=y("code");y("description");let $=y("div"),A=y("footer"),M=y("g"),_=y("h1"),R=y("h2"),W=y("h3"),E=y("h4"),T=y("h5"),N=y("header"),S=y("img"),I=y("input"),L=y("li");y("link");let B=y("main");y("meta");let P=y("nav"),O=y("p"),U=y("path"),F=y("pre");y("script");let G=y("span"),V=y("svg");y("title");let D=y("ul"),H=({to:i,action:m=Q.go,text:e,...a},p)=>{let{href:s,nofollow:t,noreferrer:n,...o}=a;return o.href=i=i||s||"",e&&p?e=[e,p]:e||(e=p||i),"/"===i[0]||"#"===i[0]?o.onclick=[m,K.preventDefault]:(o.target="_blank",o.rel="noopener",t&&(o.rel+=" nofollow"),n&&(o.rel+=" noreferrer")),j(o,e)},J=i=>{let{collapse:m,items:e=[],text:a,url:p,...s}=i,t={class:{}},{to:n}=s;n===p&&(t.class.active=!0);let o=[];return(!m||p.includes(n))&&e.length&&(o=D(e.map(i=>J({url:p,collapse:m,...i})))),L(t,[n?H(s,a):G(s,a),o])},Y=(i,m)=>{"string"==typeof i?i={content:i}:m?i={content:m,...i}:Array.isArray(i)&&(i={content:i.join("")});let{content:e,lines:a=!0}=i;return $({class:{Pre:!0,lines:a&&"false"!==a}},[$({class:"menu"},[z({onclick:[Q.pre.clip,i=>({e:i,content:e})]},"copy")]),F(e.trim().split("\n").map(Y.Line))])};Y.Comment=i=>G({class:"comment"},i),Y.Line=i=>C({class:"line"},Y.Words(i)),Y.Word=i=>{if(!i)return"";let m=i.includes("://"),e=i.startsWith("mailto:")||i.includes("@")&&i.includes(".");if(m||e)return H({to:i,text:i});let a="";return("state"===i?a="state":"actions"===i?a="actions":"effects"===i?a="effects":"subscriptions"===i?a="subscriptions":K.pre.keywords.includes(i)?a="keyword":K.pre.builtins.includes(i)?a="builtin":K.pre.booleans.includes(i)&&(a="boolean"),a)?G({class:a},i):i},Y.Words=i=>{let[m,...e]=i.split(K.pre.commentRegex);if(!m.endsWith(":")&&e.length)return[Y.Words(m),Y.Comment(e.join("").split(K.pre.wordRegex).map(Y.Word))];let a=[],p=i;return(i.replace(K.pre.stringRegex,i=>{if(p){let[m,e]=p.split(i);m&&a.push(m.split(K.pre.wordRegex).map(Y.Word).filter(i=>i)),p=e}a.push(G({class:"string"},i))}),p!==i)?(p&&a.push(p.split(K.pre.wordRegex).map(Y.Word).filter(i=>i)),a):i.split(K.pre.wordRegex).filter(i=>i).map(Y.Word)};let K={pre:{booleans:["true","false"],builtins:["Array","Object","String","Number","RegExp","Null","Symbol","Set","WeakSet","Map","WeakMap","setInterval","setTimeout","Promise","JSON","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Uint16Array","Int32Array","Uint32Array","Float32Array","Float64Array"],commentRegex:/(\/\/)/gim,keywords:["let","this","long","package","float","goto","private","class","if","short","while","protected","with","debugger","case","continue","volatile","interface","instanceof","super","synchronized","throw","extends","final","export","throws","try","import","double","enum","boolean","abstract","function","implements","typeof","transient","break","default","do","static","void","int","new","async","native","switch","else","delete","null","public","var","await","byte","finally","catch","in","return","for","get","const","char","module","exports","require","npm","install","=>"],stringRegex:/("|')(.*?)\1/gim,wordRegex:/( )/gim},undefined:{code:"ERR_UNSUPPORTED_DIR_IMPORT",url:"file:///home/j/dev/magic/util/mime-types/node_modules/@magic-libraries"}},Q={changeTheme:i=>({...i,pageClass:{...i.pageClass,light:"dark"===i.theme},theme:"dark"===i.theme?"light":"dark"}),go:(i,m)=>{if(!m||!m.currentTarget)return i;let e=m.currentTarget.href.replace(window.location.origin,""),[a,p=""]=e.split("#");if(a===i.url&&p===i.hash)return p&&(window.location.hash=p),i;let s=i.pages&&i.pages[a]&&i.pages[a].title;s&&(document.title=i.title=s),a!==i.url?p||window.scrollTo({top:0}):window.location.hash=p;let{scrollY:t}=window;return window.history.pushState({url:a,hash:p,scrollY:t},i.title,e),{...i,url:a,hash:p,prev:i.url}},nospy:{toggle:i=>(i.nospy.show=!i.nospy.show,{...i})},pop:(i,m)=>{let{pathname:e,hash:a}=window.location;a=a.substring(1);let p=0;return m.state&&(e=m.state.url,a=m.state.hash,p=m.state.scrollY||0),a?window.location.hash=a:window.scroll({top:p}),{...i,url:e,hash:a}},pre:{clip:(i,{content:m})=>{if("u">typeof document&&"function"==typeof document.execCommand){let i=document.createElement("textarea");i.id="copy",i.innerHTML=m,document.body.appendChild(i);let e=document.getElementById("copy");e.select(),document.execCommand("copy"),document.body.removeChild(e)}return i}}},X=(i,m)=>{let e=e=>i(m,e);return addEventListener("popstate",e),()=>removeEventListener("popstate",e)},Z={"/mime-types/":i=>[_(i.title),i.description.map(i=>O(i)),O("this file is autogenerated. edit ./bin/MAGIC-doc-template.js to update"),(i=>{if("string"==typeof i)i={project:i};else if(!i.project)return;let{branch:m="master",host:e="github"}=i,{project:a=!1}=i,p="",s=a;a.startsWith("@")?(p="@",a=a.substr(1)):s=a.split("/")[1];let t=[["npm",(i=a)=>i&&{to:`https://www.npmjs.com/package/${s}`,src:`https://img.shields.io/npm/v/${p}${i}?color=blue`}],["node",(i=a)=>i&&{src:`https://img.shields.io/node/v/${p}${i}?color=blue`}],["license",(i=a)=>i&&{src:`https://img.shields.io/npm/l/${p}${i}?color=blue`}],["travis",(i=a)=>i&&{to:`https://travis-ci.com/${i}`,src:`https://img.shields.io/travis/com/${i}/${m}`}],["appveyor",(i=a)=>{if(i){let[e,a]=i.split("/");return e=e.replace(/-/g,""),{to:`https://ci.appveyor.com/project/${e}/${a}/branch/${m}`,src:`https://img.shields.io/appveyor/ci/${e}/${a}/${m}.svg`}}}],["coveralls",(i=a)=>({to:`https://coveralls.io/${e}/${i}`,src:`https://img.shields.io/coveralls/${e}/${i}/${m}.svg`})],["snyk",(i=a)=>i&&{to:`https://snyk.io/test/${e}/${i}`,src:`https://img.shields.io/snyk/vulnerabilities/github/${i}.svg`}]].map(([m,e])=>e(i[m]));if(t.length)return D({class:"GitBadges"},t.map(({to:i,src:m})=>{if(!m)return;let e=(i=>{"string"==typeof i&&(i={src:i});let{loading:m="lazy"}=i;if(i.src)return i.hasOwnProperty("alt")||(i.title?i.alt=i.title:i.alt=""),i.loading=m,S(i)})({src:m,height:"23"});return i?L(H({to:i},e)):L(e)}))})("@magic/mime-types"),W({id:"install"},"installation"),O("be in a nodejs project"),Y(`
npm install @magic/mime-types
`),W({id:"usage"},"import / usage"),Y({lines:!1,content:`
...
`}),E({id:"changelog"},"changelog"),T({id:"changelog-0.0.1"},"0.0.1"),O("first publish"),R({id:"source"},"source"),O(["the source for this page is in the ",H({to:"https://github.com/magic/mime-types/tree/master/docsrc",text:"docsrc directory"})," and gets built and published to github using ",H({to:"https://github.com/magic/core",text:"@magic/core"})])],"/mime-types/404/":()=>$("404 - not found.")};k({init:{...{description:["mime-db mimetypes that have file extensions.","exports a key => value store, where key = extension and value = mime/type"],logotext:"@magic/mime-types",menu:[{text:"install",to:"/mime-types/#install"},{text:"usage",to:"/mime-types/#usage"},{text:"source",to:"/mime-types/#source"}],nospy:{show:!1},pageClass:{},pages:{"/mime-types/404/":{description:"404 - not found.",title:"404 - not found"}},root:"/mime-types/",theme:"dark",title:"@magic/mime-types",url:"/mime-types/"},url:window.location.pathname,hash:window.location.hash.substr(1)},subscriptions:i=>[[X,Q.pop]],view:i=>{let m=Z[i.url]?i.url:"/404/",e=Z[m],a=i.pages&&i.pages[m];return a&&Object.keys(a).forEach(m=>{i[m]=a[m]}),i.url=m,(({page:i,state:m},e)=>B({id:"Magic",class:m.pageClass},$({class:{Wrapper:!0}},[((i={},m=[])=>{let{logo:e,menu:a,logotext:p,hash:s,url:t}=i;if(e||a||p)return N({class:"Header"},[H({to:"/",class:"Logo"},[V({viewBox:"0 0 512 444"},[U({d:"M512 444L256 0 0 444z",fill:"#663695"}),q({cx:"256",cy:"294",r:"130",fill:"#fff"}),q({cx:"256",cy:"281",r:"40",fill:"#663695"}),U({d:"M256 350v44m24-44l1 13c1 27 29 27 29-7m-160-72s46-47 106-47c59 0 106 47 106 47s-47 43-106 43c-60 0-106-43-106-43zm65-75a134 134 0 0189 2",class:"stroke"}),U({d:"M256 81v53m184 270l-43-29M72 404l43-29",class:"stroke white"})])]),p&&O(p),a&&((i={})=>{let{collapse:m=!0,menu:e,hash:a}=i,{class:p="",url:s}=i;return p.includes("Menu")||(p=`Menu ${p}`.trim()),a&&!s.endsWith(a)&&(s+=`#${a}`),P({className:p},D(e.map(i=>J({...i,url:s,collapse:m}))))})({url:t,hash:s,menu:a}),m])})(m),$({class:"Page",id:"page"},i(m)),((i,m=[])=>A({class:"Footer"},[$({class:"Container"},[$({class:"Credits"},["made with a few bits of ",H({to:"https://magic.github.io/",target:"_blank",rel:"noopener"},"magic")]),m])]))(0),e])))({page:e,state:i},[(({nospy:i={},cookies:m=[]})=>{let{show:e,title:a="Privacy Notice",content:p="This app neither saves, collects, nor shares any data about you.",buttonText:s="Awesome!"}=i;return e?$({class:"NoSpy"},[$({class:"Background",onclick:Q.nospy.toggle}),$({class:"Container"},[a&&W(a),p&&O(p),I({onclick:Q.nospy.toggle,value:s,type:"button"})])]):$({class:"NoSpy"},V({class:"icon",onclick:Q.nospy.toggle,width:"25",height:"25",viewBox:"0 0 512 512"},[M([U({d:`
...
`}),q({cx:"192",cy:"128",r:"32"}),q({cx:"128",cy:"256",r:"32"}),q({cx:"288",cy:"384",r:"32"}),q({cx:"272",cy:"272",r:"16"}),q({cx:"400",cy:"336",r:"16"}),q({cx:"176",cy:"368",r:"16"})])]))})(i),((i={})=>V({class:"LightSwitch icon",onclick:Q.changeTheme,height:25,width:25,viewBox:"0 0 352 460"},[U({d:"M149 48C96 48 48 95 47 143c-1 13 19 17 20 0-1-35 48-75 83-75 15 0 12-22-1-20z"}),U({d:"M176 0C74 0 0 83 0 176c9 91 84 118 100 204h20c-16-92-97-138-100-204C22 70 105 21 176 20zM95 400c2 68 20 48 40 60h82c20-12 38 8 40-60z"}),U({d:"M175 0c102 0 177 83 177 176-9 91-86 118-102 204h-20c16-92 99-138 102-204-2-106-86-155-157-156z"})]))(i)])},node:document.getElementById("Magic")})};__MAGIC__();